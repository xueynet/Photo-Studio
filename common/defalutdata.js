export default{
	goods:[
		...
		},
		{
			...
			id:5,
			price: "116.00",
			title: '拾柒照片书 相册定制制作照片diy定制书520七夕情人节周年纪念成长礼物毕业杂志册相册簿影集相册本 【048页】含扉页版权页 建议46~230张照片 大尺寸170*230mm 精装硬壳',
			shop: '999+',
			comment:{
				avatar:'头像',
				name:'小恐龙',
			...
			id:6,
			price: "14.90",
			title: '益好定制 洗照片 1英寸2英寸证件照 照片冲印冲洗相片手机大头贴换底色登记照片定制 共72张：1寸红白蓝底各16张+2寸红白蓝底各8张 换红白蓝底共三版',
			shop: '999+',
			comment:{
				avatar:'头像',
				name:'大恐龙',
			...
			id:7,
			price: "60.00",
			title: '贝阳（beiyang）摄影背景布视频拍摄绿幕抠像布补光灯摄影棚拍照背景纯色绿布背景套装道具1.8*2.9绿色',
			shop: '999+',
			comment:{
				avatar:'头像',
				name:'小王',
			...
			id:8,
			price: "11499.00 ",
			title: '索尼（SONY）Alpha 7 III 机身（a7M3/A73/ILCE-7M3）全画幅微单数码相机 （约2420万有效像素 5轴防抖 ）',
			shop: '999+',
			comment:{
				avatar:'头像',
				name:'小明',
			...
			id:9,
			price: "5279.00",
			title: '佳能（Canon）EOS 200D II 200D2 迷你单反相机 18-55标准变焦镜头套装 白色 （ 约2410万像素/4K短片）',
			shop: '999+',
			comment:{
				avatar:'头像',
				name:'小红',
			...
			id:10,
			price: "518.00",
			title: '国画山水画旭日东升办公室挂画客厅装饰画书房字画沙发背景墙靠山图新中式水墨画风水招财聚宝盆风景已装裱 鸿运当头 画框16383厘米',
			shop: '999+',
			comment:{
				avatar:'头像',
				name:'张三',
	...
	news:[
		{
			id:1,
			title: 'PS图片处理修图改图p图去水印专业P图服务改字照片合成证件照处理换背景调色精修婚纱照修改文字处理',
			image: '/static/images/news/b1.jpg',
			soure:'作者',
			adddate:'2022-01-20',
		},
		{
			id:2,
			title: 'PS图片处理修图改图p图去水印专业P图服务改字照片合成证件照处理换背景调色精修婚纱照修改文字处理',
			image: '/static/images/news/b2.jpg',
			soure:'作者',
			adddate:'2022-01-20',
		},
		{
			id:3,
			title: 'PS图片处理修图改图p图去水印专业P图服务改字照片合成证件照处理换背景调色精修婚纱照修改文字处理',
			image: '/static/images/news/b3.jpg',
			soure:'作者',
			adddate:'2022-01-20',
		},
		{
			id:4,
			title: 'PS图片处理修图改图p图去水印专业P图服务改字照片合成证件照处理换背景调色精修婚纱照修改文字处理',
			image: '/static/images/news/b4.jpg',
			soure:'作者',
			adddate:'2022-01-20',
		},
		{
			id:5,
			title: 'PS图片处理修图改图p图去水印专业P图服务改字照片合成证件照处理换背景调色精修婚纱照修改文字处理',
			image: '/static/images/news/b5.jpg',
			soure:'作者',
			adddate:'2022-01-20',
		},
		{

<template>
	...
	>
		<u-icon :size="iconSize" :name="icon" :custom-prefix="customPrefix===''?'uicon':customPrefix" v-if="icon||customPrefix" :custom-style="iconStyle" class="u-cell__left-icon-wrap"></u-icon>
